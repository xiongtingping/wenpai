...
# 新配置
NEW_APPID="687e0aafee2b84f86685b644"
NEW_HOST="ai-wenpai.authing.cn/687e0aafee2b84f86685b644"
...
# 替换 AppID
find . -type f \( -name '*.ts' -o -name '*.tsx' -o -name '*.js' -o -name '*.cjs' -o -name '*.json' -o -name '*.env*' \) -exec sed -i '' "s/$OLD_APPID1/$NEW_APPID/g" {} +
find . -type f \( -name '*.ts' -o -name '*.tsx' -o -name '*.js' -o -name '*.cjs' -o -name '*.json' -o -name '*.env*' \) -exec sed -i '' "s/$OLD_APPID2/$NEW_APPID/g" {} +

# 替换认证域名
find . -type f \( -name '*.ts' -o -name '*.tsx' -o -name '*.js' -o -name '*.cjs' -o -name '*.json' -o -name '*.env*' \) -exec sed -i '' "s@$OLD_HOST1@$NEW_HOST@g" {} +
find . -type f \( -name '*.ts' -o -name '*.tsx' -o -name '*.js' -o -name '*.cjs' -o -name '*.json' -o -name '*.env*' \) -exec sed -i '' "s@$OLD_HOST2@$NEW_HOST@g" {} +
find . -type f \( -name '*.ts' -o -name '*.tsx' -o -name '*.js' -o -name '*.cjs' -o -name '*.json' -o -name '*.env*' \) -exec sed -i '' "s@$OLD_HOST3@$NEW_HOST@g" {} +
