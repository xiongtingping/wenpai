...
docId: string; fileName: string; excerpt: string; confidence: number } } } {
  ...
  private getFieldExtractionRules(): { [fieldName: string]: string } {
    return {
      ...
      'brandTone': '请分析文案的语言风格、表达方式、情感色彩，避免通用词汇，要具体化（如：温暖亲和、严谨专业、活力年轻），必须提供支撑例句',
      'brandPersonality': '请分析品牌的人格化特征和与用户互动方式，避免模糊词汇，要具体化（如：睿智导师型、贴心朋友型、创新先锋型）',
      'slogans': '请从资料中提取品牌主张、座右铭、标语、口号',
      'values': '请提取具体的行为准则和信念，避免空洞口号（如：诚信、品质），要具体化（如：匠心传承古法工艺、坚持纯天然原料）',
      'missionVision': '请分别提取使命（存在意义/承诺）和愿景（希望达成的目标），包含具体目标',
      'brandStory': '按时间线提取：创立背景→发展历程→重要转折→现状成就，突出独特性和品牌特色故事，避免流水账',
      'adSlogans': '请提取广告语、推广语、营销口号',
      'productDescriptors': '请提取产品描述中的关键词、特色词汇',
      'coreTopics': '请按重要性分层提取：核心话题（3-5个）、次要话题（5-8个），避免宽泛词汇，要具体化（如：东方哲学智慧、古法酿造工艺）',
      'hashtags': '请按分类生成适合的社交媒体标签：品牌相关、产品相关、生活方式相关、价值观相关，包含使用场景',
