...
class MultiDimensionalTrendService {
  ...
  private inferCategory(item: DailyHotItem): string {
    ...
    if (title.includes('u64cdu4f5cu5931u8d25') || title.includes('ai')) return 'u64cdu4f5cu5931u8d25';
    if (title.includes('u64cdu4f5cu5931u8d25') || title.includes('u64cdu4f5cu5931u8d25')) return 'u64cdu4f5cu5931u8d25';
    if (title.includes('u64cdu4f5cu5931u8d25') || title.includes('u64cdu4f5cu5931u8d25')) return 'u64cdu4f5cu5931u8d25';
    return '其他';
  }
