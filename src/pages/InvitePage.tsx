          ...
          <Card className="border-2 border-blue-100 overflow-hidden shadow-lg">
            ...
            <CardContent className="p-8">
              <div className="space-y-8">
                {/* 邀请链接区域 */}
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-gray-800">您的专属邀请链接</h3>
                  <div className="flex space-x-3">
                    <Input 
                      value={inviteUrl} 
                      readOnly 
                      className="bg-gray-50 font-medium text-blue-800 text-lg py-3" 
                    />
                    <Button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-lg font-semibold text-blue-800 mb-2">邀请奖励</p>
                      <p className="text-3xl font-bold text-blue-900">+20 次</p>
                  ...
                  <Card className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200">
                    <CardContent className="p-6 text-center">
                      <div className="text-4xl mb-2">💎</div>
                      <p className="text-lg font-semibold text-green-800 mb-2">当前可用</p>
                      <p className="text-3xl font-bold text-green-900">{usageRemaining}</p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Button 
                    ...
                    className="flex-1 py-3 text-lg border-2 border-blue-200 hover:border-blue-300 hover:bg-blue-50"
                  >
                    <RefreshCw className="h-5 w-5 mr-2" /> 创建新链接
                  </Button>
                  <Button 
                    className="flex-1 py-3 text-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700"
                  >
                    <Share2 className="h-5 w-5 mr-2" /> 立即分享
                  </Button>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent>
                <div className="flex space-x-3">
                  <Input 
                    ...
                    readOnly 
                    className="bg-white font-medium text-lg py-3 border-green-300" 
                  />
                  <Button 
                    onClick={() => {
                  ...
                  >
                    <Copy className="h-5 w-5 mr-2" /> 复制
                  </Button>
                </div>
