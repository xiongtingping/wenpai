...
const videoForms: ContentForm[] = [
  ...
  },
  {
    id: 'comedy-reversal',
    name: '段子/反转视频',
    description: '突出笑点和意外反转，构建极简但高爆点内容结构',
    icon: '😂',
    category: 'video',
    outputType: '短视频脚本',
    characteristics: [
...
const interviewForms: ContentForm[] = [
  ...
  },
  {
    ...
    name: '虚拟采访',
    description: '主持人提问 + 嘉宾回答格式，模拟播客、直播访谈等场景',
    icon: '🎙️',
    category: 'interview',
    outputType: '访谈脚本',
    characteristics: [
...
const insightForms: ContentForm[] = [
  {
    id: 'trend-opinion',
    name: '趋势观点表达',
    description: '以专家视角输出新趋势，采用"观点→论据→总结/延伸"结构',
    icon: '📈',
    category: 'insight',
    outputType: '观点文章',
    characteristics: [
...
export const contentCategories: ContentCategory[] = [
  ...
  },
  {
    id: 'interview',
    name: '访谈/对话类',
    description: '输出：对话/访谈脚本',
    icon: '💬',
    outputDescription: '对话/访谈脚本',
    forms: interviewForms
  },
  {
    id: 'insight',
    name: '洞察类',
    description: '输出：观点/情感/营销内容',
    icon: '🔍',
