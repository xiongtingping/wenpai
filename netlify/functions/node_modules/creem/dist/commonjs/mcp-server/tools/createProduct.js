...
exports.tool$createProduct = void 0;
...
exports.tool$createProduct = {
    name: "create-product",
    description: `Creates a new product.`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, createProduct_js_1.createProduct)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
