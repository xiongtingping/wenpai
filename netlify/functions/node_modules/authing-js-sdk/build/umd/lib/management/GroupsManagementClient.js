    ...
    var GroupsManagementClient = /** @class */ (function () {
        ...
        GroupsManagementClient.prototype.create = function (code, name, description) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.createGroup)(this.graphqlClient, this.tokenProvider, {
                                code: code,
                                name: name,
        ...
        GroupsManagementClient.prototype.delete = function (code) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.deleteGroups)(this.graphqlClient, this.tokenProvider, {
                                codeList: [code]
                            })];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.updateGroup)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    name: name,
                                    description: description,
                                    newCode: newCode
        ...
        GroupsManagementClient.prototype.detail = function (code) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.group)(this.graphqlClient, this.tokenProvider, {
                                code: code
                            })];
                        case 1:
                            data = (_a.sent()).group;
        ...
        GroupsManagementClient.prototype.list = function (page, limit) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.getGroups)(this.graphqlClient, this.tokenProvider, {
                                page: page,
                                limit: limit
                            })];
                        case 1:
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.groupWithUsers)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    page: page,
                                    limit: limit
                                })];
                        ...
                        case 2: return [4 /*yield*/, (0, graphqlapi_1.groupWithUsersWithCustomData)(this.graphqlClient, this.tokenProvider, {
                                code: code,
                                page: page,
                                limit: limit
                            })];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.listGroupAuthorizedResources)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    namespace: namespace,
