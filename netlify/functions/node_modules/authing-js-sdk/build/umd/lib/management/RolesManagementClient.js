    ...
    var RolesManagementClient = /** @class */ (function () {
        ...
        RolesManagementClient.prototype.create = function (code, description, namespace) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.addRole)(this.graphqlClient, this.tokenProvider, {
                                code: code,
        ...
        RolesManagementClient.prototype.delete = function (code, namespace) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.deleteRole)(this.graphqlClient, this.tokenProvider, {
                                code: code,
                                namespace: namespace
                            })];
                        case 1:
        ...
        RolesManagementClient.prototype.deleteMany = function (codeList, namespace) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.deleteRoles)(this.graphqlClient, this.tokenProvider, {
                                codeList: codeList,
                                namespace: namespace
                            })];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.updateRole)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    description: description,
                                    newCode: newCode,
                                    namespace: namespace
        ...
        RolesManagementClient.prototype.detail = function (code, namespace) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.role)(this.graphqlClient, this.tokenProvider, {
                                code: code,
                                namespace: namespace
                            })];
                        case 1:
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.roles)(this.graphqlClient, this.tokenProvider, {
                                    page: page,
                                    limit: limit,
                                    namespace: namespace
                                })];
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.roleWithUsers)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    namespace: namespace,
                                    page: page,
                                    limit: limit
                        ...
                        case 2: return [4 /*yield*/, (0, graphqlapi_1.roleWithUsersWithCustomData)(this.graphqlClient, this.tokenProvider, {
                                code: code,
                                namespace: namespace,
                                page: page,
                                limit: limit
        ...
        RolesManagementClient.prototype.listPolicies = function (code, page, limit) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.policyAssignments)(this.graphqlClient, this.tokenProvider, {
        ...
        RolesManagementClient.prototype.addPolicies = function (code, policies) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.addPolicyAssignments)(this.graphqlClient, this.tokenProvider, {
        ...
        RolesManagementClient.prototype.removePolicies = function (code, policies) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, graphqlapi_1.removePolicyAssignments)(this.graphqlClient, this.tokenProvider, {
                                targetType: graphql_v2_1.PolicyAssignmentTargetType.User,
                                targetIdentifiers: [code],
                                policies: policies
                            })];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, graphqlapi_1.listRoleAuthorizedResources)(this.graphqlClient, this.tokenProvider, {
                                    code: code,
                                    namespace: namespace,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            list = (_a.sent()).udv;
                            udfMap = (0, utils_1.convertUdvToKeyValuePair)(list);
                            udfValue = {};
                            for (key in udfMap) {
                                if (udfKey === key) {
