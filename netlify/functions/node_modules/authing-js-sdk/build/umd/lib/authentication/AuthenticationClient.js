...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./AuthenticationTokenProvider", "./types", "crypto-js/sha256", "crypto-js", "../graphqlapi", "../common/GraphqlClient", "./types", "../../types/graphql.v2", "./QrCodeAuthenticationClient", "./BrowserFingerprintClient", "./MfaAuthenticationClient", "../common/HttpClient", "../utils", "jwt-decode", "./SocialAuthenticationClient", "../common/PublicKeyManager", "./EnterpriseAuthenticationClient", "./BaseAuthenticationClient", "./PrincipalAuthentication", "./EventAuthenticationClient"], factory);
    }
    ...
    var BrowserFingerprintClient_1 = require("./BrowserFingerprintClient");
    ...
    var EventAuthenticationClient_1 = require("./EventAuthenticationClient");
    var DEFAULT_OPTIONS = {
        appId: undefined,
        tenantId: undefined,
        appHost: undefined,
    ...
    var AuthenticationClient = /** @class */ (function () {
        function AuthenticationClient(options) {
            ...
            this.browserFingerprint = new BrowserFingerprintClient_1.BrowserFingerprintClient(this.options, this.httpClient);
            ...
            this.event = new EventAuthenticationClient_1.EventAuthenticationClient(this.options, this.tokenProvider, this.httpClient);
        }
         ...
         * 只退出当前设备
         */
        AuthenticationClient.prototype.logoutCurrent = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.httpClient.request({
        ...
        AuthenticationClient.prototype.computedPasswordSecurityLevel = function (password) {
            ...
            if (password.match(highLevel) !== null) {
                return types_2.PasswordSecurityLevel.HIGH;
            }
            if (password.match(middleLevel) !== null) {
                return types_2.PasswordSecurityLevel.MIDDLE;
            }
            return types_2.PasswordSecurityLevel.LOW;
        };
        ...
        AuthenticationClient.prototype.getAccessTokenByIdToken = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                var redirectUri, idToken, _a, scope, protocolApiMap, api, tokenSet;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            redirectUri = options.redirectUri, idToken = options.idToken, _a = options.scope, scope = _a === void 0 ? '' : _a;
                            protocolApiMap = {
                                oidc: '/oidc/token',
                                oauth: '/oauth/token'
                            };
         ...
         * @deprecated
         */
        AuthenticationClient.prototype.signinByCredentials = function (params) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function () {
                var res, state;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            if (((_a = params.options) === null || _a === void 0 ? void 0 : _a.responseType) === types_1.SignInResponseType.Code) {
                                params.options.redirectUri =
                                    params.options.redirectUri || this.options.redirectUri;
                            }
                            return [4 /*yield*/, this.naiveHttpClient.request({
                                    url: "".concat(this.baseClient.appHost, "/api/v3/signin"),
                                    data: params,
                                    method: 'POST',
                                    notHandleRes: true
                                })];
                        case 1:
                            ...
                            if (res.statusCode === 200) {
                                if ((_b = params.options) === null || _b === void 0 ? void 0 : _b.autoRedirect) {
                                    console.log("".concat(params.options.redirectUri, "?code=").concat(res.data.code, "&state=").concat(state));
                                    window.location.href = "".concat(params.options.redirectUri, "?code=").concat(res.data.code, "&state=").concat(params.options.state ||
                                        Math.random()
                                            .toString(36)
                                            .slice(-8));
                                }
                                return [2 /*return*/, __assign(__assign({}, res.data), { state: state })];
                            }
