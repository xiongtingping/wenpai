(function (factory) {
    ...
    exports.SignInResponseType = exports.PasswordEncryptType = exports.SigninByCredentialsConnection = exports.RelayMethodEnum = exports.SceneType = exports.OIDCConnectionMode = exports.LoginMethods = exports.RegisterMethods = exports.AppPasswordStrengthLimit = exports.Protocol = exports.SocialConnectionProvider = exports.PasswordSecurityLevel = void 0;
    /**
     * 密码安全等级
     */
    ...
    (function (RelayMethodEnum) {
        ...
        RelayMethodEnum["QUERY"] = "query"; // 302 将客户端重定向到 target，查询参数携带用户信息（风变科技需求，向前兼容 callback url 参数用）
    })(RelayMethodEnum = exports.RelayMethodEnum || (exports.RelayMethodEnum = {}));
    var SigninByCredentialsConnection;
    (function (SigninByCredentialsConnection) {
        SigninByCredentialsConnection["PASSWORD"] = "PASSWORD";
        SigninByCredentialsConnection["PASSCODE"] = "PASSCODE";
        SigninByCredentialsConnection["LDAP"] = "LDAP";
        SigninByCredentialsConnection["AD"] = "AD";
    })(SigninByCredentialsConnection = exports.SigninByCredentialsConnection || (exports.SigninByCredentialsConnection = {}));
    var PasswordEncryptType;
    (function (PasswordEncryptType) {
        PasswordEncryptType["SM2"] = "sm2";
        PasswordEncryptType["RSA"] = "rsa";
        PasswordEncryptType["NONE"] = "none";
    })(PasswordEncryptType = exports.PasswordEncryptType || (exports.PasswordEncryptType = {}));
    var SignInResponseType;
    (function (SignInResponseType) {
        SignInResponseType["IdTokenToken"] = "id_token token";
        SignInResponseType["Code"] = "code";
    })(SignInResponseType = exports.SignInResponseType || (exports.SignInResponseType = {}));
});
