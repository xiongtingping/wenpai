...
import { BrowserFingerprintClient } from './BrowserFingerprintClient';
...
import { EventAuthenticationClient } from './EventAuthenticationClient';
var DEFAULT_OPTIONS = {
    appId: undefined,
    tenantId: undefined,
    appHost: undefined,
...
var AuthenticationClient = /** @class */ (function () {
    function AuthenticationClient(options) {
        ...
        this.browserFingerprint = new BrowserFingerprintClient(this.options, this.httpClient);
    ...
    AuthenticationClient.prototype.signinByCredentials = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (((_a = params.options) === null || _a === void 0 ? void 0 : _a.responseType) === SignInResponseType.Code) {
