...
console.log('\n3. 检查网络和DNS');
console.log('   - 测试 aiwenpai.authing.cn 是否可访问');
...
console.log('=====================================');
console.log('当前请求参数：');
console.log('- client_id: 687cc2a82e907f6e8aea5848');
...
console.log('   curl -I https://aiwenpai.authing.cn');
console.log('');
console.log('2. 测试OIDC配置：');
console.log('   curl https://aiwenpai.authing.cn/oidc/.well-known/openid-configuration');
console.log('');
console.log('3. 测试JWKS：');
console.log('   curl https://aiwenpai.authing.cn/oidc/.well-known/jwks.json');
