...
function doEncrypt(msg, publicKey, cipherMode) {
    ...
    var y2 = _.hexToArray(_.leftPad(p
        ...
        .toRadix(16), 64));
    // c3 = hash(x2 || msg || y2)
    var c3 = _.arrayToHex((0, sm3_1.default)([].concat(x2, msg, y2)));
    var ct = 1;
    var offset = 0;
    var t = []; // 256 位
    var z = [].concat(x2, y2);
    var nextT = function () {
        // (1) Hai = hash(z || ct)
        // (2) ct++
        t = (0, sm3_1.default)(__spreadArray(__spreadArray([], z, true), [
            (ct >> 24) & 0x00ff,
            (ct >> 16) & 0x00ff,
            (ct >> 8) & 0x00ff,
            ct & 0x00ff
...
function doDecrypt(encryptData, privateKey, cipherMode, _a) {
    ...
    // c3 = hash(x2 || msg || y2)
    var checkC3 = _.arrayToHex((0, sm3_1.default)([].concat(x2, msg, y2)));
    if (checkC3 === c3) {
...
function doVerifySignature(msg, signHex, publicKey, _a) {
    ...
    var s;
    if (der) {
        var decodeDerObj = (0, asn1_1.decodeDer)(signHex); // asn.1 der 解码
        r = decodeDerObj.r;
        s = decodeDerObj.s;
    }
    else {
...
function getHash(hashHex, publicKey, userId) {
    ...
    var z = (0, sm3_1.default)(data);
    // e = hash(z || msg)
    return _.arrayToHex((0, sm3_1.default)(z.concat(_.hexToArray(hashHex))));
}
/**
 * 计算公钥
 */
