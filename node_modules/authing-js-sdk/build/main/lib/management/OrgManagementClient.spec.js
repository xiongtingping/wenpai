...
(0, ava_1.default)('通过 json 导入组织机构', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('添加成员', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('create', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                code = (0, testing_helper_1.generateRandomString)();
                name = (0, testing_helper_1.generateRandomString)();
                return [4 /*yield*/, managementClient.org.create(name, (0, testing_helper_1.generateRandomString)(), code)];
            case 1:
                org = _a.sent();
...
(0, ava_1.default)('addNode', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var org, rootNode, name, newNode;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.org.create((0, testing_helper_1.generateRandomString)(), (0, testing_helper_1.generateRandomString)(), (0, testing_helper_1.generateRandomString)())];
            case 1:
                org = _a.sent();
...
(0, ava_1.default)('updateNode', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('findById', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var org;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.org.create((0, testing_helper_1.generateRandomString)(), (0, testing_helper_1.generateRandomString)(), (0, testing_helper_1.generateRandomString)())];
...
(0, ava_1.default)('listAuthorizedResourcesByNodeId', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('listAuthorizedResourcesByNodeCode', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
