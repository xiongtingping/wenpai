...
(0, ava_1.default)('list applications', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('applications findById', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('资源', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('创建资源', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, res;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('修改资源', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('删除资源', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('获取应用访问控制策略', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var list;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('配置「允许主体（用户、角色、分组、组织机构节点）访问应用」的控制策略', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('启用应用访问控制策略', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('配置「拒绝主体（用户、角色、分组、组织机构节点）访问应用」的控制策略', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var username, pwd, user, res, res2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('更改默认应用访问策略（默认拒绝所有用户访问应用、默认允许所有用户访问应用）', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var res2, res3;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('创建角色', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, role, roleInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                code = (0, testing_helper_1.generateRandomString)(5);
...
(0, ava_1.default)('更新角色', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                description = (0, testing_helper_1.generateRandomString)(10);
            ...
            case 2:
                ...
                newCode = (0, testing_helper_1.generateRandomString)();
                return [4 /*yield*/, applications.updateRole(APP_ID, {
                        code: code,
                        newCode: newCode,
                        description: description
...
(0, ava_1.default)('查询角色详情', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('删除角色', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('批量删除角色', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('查询空 Code 的角色', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('listAuthorizedResources', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var code, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('创建注册协议', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var title;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('修改注册协议', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var id, title;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, applications.createAgreement(APP_ID, {
...
(0, ava_1.default)('注册协议排序', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('changeTenantConfig', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('applicationTenants', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
