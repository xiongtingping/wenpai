...
var authenticationClient = new AuthenticationClient_1.AuthenticationClient((0, testing_helper_1.getOptionsFromEnv)());
(0, ava_1.default)('创建用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var username, email, phone, unionid, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                username = (0, testing_helper_1.generateRandomString)(10);
                email = (0, testing_helper_1.generateRandomString)(10);
                phone = (0, testing_helper_1.generateRandomPhone)();
                unionid = (0, testing_helper_1.generateRandomString)(10);
...
(0, ava_1.default)('创建用户 # 必须指定一种唯一标志', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var failed, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, managementClient.users.create({
                        password: (0, testing_helper_1.generateRandomString)(10)
                    })];
            case 2:
                _b.sent();
                return [3 /*break*/, 4];
...
(0, ava_1.default)('创建用户 # 时间格式1', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('创建用户 # signedUp', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var signedUp, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                user = _a.sent();
                t.assert((0, moment_1.default)(user.signedUp).unix() === (0, moment_1.default)(signedUp).unix());
                return [2 /*return*/];
        }
    });
}); });
(0, ava_1.default)('创建用户 # 错误时间格式', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var failed, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
(0, ava_1.default)('检查用户是否存在', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 1:
                ...
                username = (0, testing_helper_1.generateRandomString)(10);
                email = (0, testing_helper_1.generateRandomString)(10) + '@qq.com';
                phone = (0, testing_helper_1.generateRandomPhone)();
                return [4 /*yield*/, managementClient.users.create({
                        username: username
                    })];
...
(0, ava_1.default)('查询用户详情', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user, detail;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.users.create({
...
(0, ava_1.default)('查询用户详情 # 不属于该用户池的用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var detail;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('管理员通过 username 查询用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('管理员通过 emmail 查询用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('管理员通过 phone 查询用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('管理员通过 externalId 查询用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                userCreated = _a.sent();
                externalId = (0, testing_helper_1.generateRandomString)();
...
(0, ava_1.default)('list withCustomData', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('filter', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var users;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('批量查询用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('搜索用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('修改用户资料', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                nickname = (0, testing_helper_1.generateRandomString)(10);
...
(0, ava_1.default)('修改用户资料 # 邮箱', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('修改用户资料 # 手机号', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('获取用户角色列表', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user, role, roles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.users.create({
            ...
            case 1:
                user = _a.sent();
                return [4 /*yield*/, managementClient.roles.create((0, testing_helper_1.generateRandomString)())];
            case 2:
                role = _a.sent();
...
(0, ava_1.default)('删除用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user, user2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.users.create({
...
(0, ava_1.default)('refreshToken', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user, token, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, managementClient.users.create({
...
(0, ava_1.default)('自定义数据', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('getUdfValueBatch', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('setUdfValueBatch', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('踢下线一批用户', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('用户池管理员根据用户 id 查询用户的登录状态', function (t) { return __awaiter(void 0, void 0, void 0, function () {
...
(0, ava_1.default)('用户池管理员强制下线用户在某个应用的登录态', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var username, pwd, user, res2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                ...
                return [4 /*yield*/, managementClient.users.logout({
                        userId: user.id,
                        appId: (0, testing_helper_1.getOptionsFromEnv)().appId
                    })];
            case 3:
                res2 = _a.sent();
...
(0, ava_1.default)('用户池管理员强制下线用户在所有应用的登录态', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var username, pwd, user, res2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
(0, ava_1.default)('detail withCustomData', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('batch withCustomData', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var users;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
//   t.assert(result);
// });
(0, ava_1.default)('getApplicationLoginUserNum', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
(0, ava_1.default)('getUdfFieldUserNum', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
