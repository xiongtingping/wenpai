...
(function (factory) {
    ...
    var options = (0, testing_helper_1.getOptionsFromEnv)();
    var authenticationClient = new AuthenticationClient_1.AuthenticationClient(options);
    (0, ava_1.default)('获取用户 MFA 认证器列表', function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var password, email, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    password = (0, testing_helper_1.generateRandomString)(14);
                    email = (0, testing_helper_1.generateRandomEmail)().toLocaleLowerCase();
    ...
    (0, ava_1.default)('用户请求绑定 MFA 认证器', function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var password, email, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    (0, ava_1.default)('用户解绑 MFA 认证器', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, ava_1.default)('用户确认绑定 MFA 认证器', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, ava_1.default)('MFA 口令二次认证', function (t) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    (0, ava_1.default)('MFA 恢复代码二次认证', function (t) { return __awaiter(void 0, void 0, void 0, function () {
