            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_o) {
                    ...
                    if (!node) {
                        ...
                        node.id = domId;
                        (0, utils_1.createCssClassStyleSheet)('__authing-qrcode-node-mount', "z-index: 65535;position: fixed;background: #fff;width: ".concat(containerSize.width, "px;height: ").concat(containerSize.height, "px;left: 50%;margin-left: -").concat(containerSize.width /
                            2, "px;display: flex;justify-content: center;align-items: center;top: 50%;margin-top: -").concat(containerSize.height /
                    ...
                    genTip = function (text) {
                        ...
                        if (!needGenerate) {
                            (0, utils_1.createCssClassStyleSheet)('__authing__heading-subtitle-style', 'display: block;font-weight: 400;font-size: 15px;color: #888;line-height: 20px;margin-top: 8px;');
                            tip.classList.add('__authing__heading-subtitle-style');
                        }
                        else {
                            (0, utils_1.createCssClassStyleSheet)('__authing__heading-subtitle-style', 'display: block;font-weight: 400;font-size: 12px;color: #888;');
                            tip.classList.add('__authing__heading-subtitle-style');
                        }
                    ...
                    genShadowMiddleStatus = function (text) {
                        ...
                        (0, utils_1.createCssClassStyleSheet)('__authing-shadow-inner-text-style-position', "font-weight: 400;font-size: 14px;line-height: 20px;color: #282D3C;;align-items: center; /*\u5782\u76F4\u5C45\u4E2D*/justify-content: center; /*\u6C34\u5E73\u5C45\u4E2D*/");
                    ...
                    genReferTextNode = function (text) {
                        ...
                        (0, utils_1.createCssClassStyleSheet)('__authing-shadow-inner-refer-text-style-position', "color: #215AE5;font-size: 14px;line-height:20px;font-weight: 400; text-align:center;cursor:pointer;padding-top:4px;");
                    ...
                    genShadow = function (text, aOnClick, shadowAId) {
                        ...
                        shadow.id = shadowId;
                        (0, utils_1.createCssClassStyleSheet)('__authing-shadow-style', "text-align:center;width: ".concat(size.width, "px;height: ").concat(size.height, "px;position: absolute;left: 50%;top: 0px;margin-left: -").concat(size.width /
                            2, "px;background-color: rgba(0,0,0, 0.5);line-height:").concat(size.height, "px;color:#fff;font-weight:600;"));
                    ...
                    displayScannedUser = function (_) {
                        ...
                        (0, utils_1.createCssClassStyleSheet)('__authing-shadow-style-position', "text-align:center;width:".concat(size.width, "px;height: ").concat(size.height, "px;background:rgba(255,255,255,.97);position: absolute;left: 50%;top: 0px;margin-left: -").concat(size.width /
                            2, "px;line-height:").concat(size.height, "px;color:#fff;font-weight:600;display: flex;\n      align-items: center; /*\u5782\u76F4\u5C45\u4E2D*/\n      justify-content: center; /*\u6C34\u5E73\u5C45\u4E2D*/"));
