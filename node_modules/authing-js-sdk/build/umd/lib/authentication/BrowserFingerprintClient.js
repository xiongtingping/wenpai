...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils", "../browserInfo", "./BaseAuthenticationClient"], factory);
    }
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, utils_1.createFingerprint)()];
                        case 1:
                            ...
                            _b.label = 2;
                        case 2: return [2 /*return*/, { browserId: localBrowserId, deviceFingers: (0, browserInfo_1.handleFingerprint)(localDeviceFingersObj) }];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, browserInfo_1.BrowserInfoFun)()];
                        case 2:
                            BrowserInfo = _c.sent();
                            return [4 /*yield*/, this.httpClient.request({
                                    method: 'POST',
                                    url: "".concat(this.baseClient.appHost, "/api/v3/create-device"),
                                    data: __assign(__assign({ deviceUniqueId: browserFingers.browserId, name: (_a = (0, browserInfo_1.getBrowserInfo)()) === null || _a === void 0 ? void 0 : _a.toString() }, BrowserInfo), browserFingers)
                                })];
                        case 3:
                            _c.sent();
