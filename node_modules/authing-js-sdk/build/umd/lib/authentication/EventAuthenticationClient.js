...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./BaseAuthenticationClient", "../version"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EventAuthenticationClient = void 0;
     ...
     */
    var EventAuthenticationClient = /** @class */ (function () {
        function EventAuthenticationClient(options, tokenProvider, httpClient) {
        ...
        EventAuthenticationClient.prototype.reconnect = function (eventName) {
            var _this = this;
        ...
        EventAuthenticationClient.prototype.initWebSocket = function (eventName, retry) {
            var _this = this;
        ...
        EventAuthenticationClient.prototype.sub = function (eventName, callback, errCallback) {
            var _this = this;
            /**
             * 1. 判断是否连接 socket
             * 2. 获取 socket 实例
         ...
         * @returns
         */
        EventAuthenticationClient.prototype.pub = function (eventName, data) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.httpClient.request({
                                    ...
                                    data: {
                                        eventType: eventName,
                                        source: "authing-js-sdk: ".concat(version_1.SDK_VERSION),
                                        eventData: data
                                    },
                                })];
        ...
        return EventAuthenticationClient;
    }());
    exports.EventAuthenticationClient = EventAuthenticationClient;
});
//# sourceMappingURL=EventAuthenticationClient.js.map