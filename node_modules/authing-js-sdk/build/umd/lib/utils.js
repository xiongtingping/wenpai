...
(function (factory) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        fingerParamsObj.webgl = (0, browserInfo_1.getWebGLValues)() ? sha256WithLengthControl((0, browserInfo_1.getWebGLValues)().toString()) : '';
                        ...
                        localStorage.setItem('browserId', browserId); // 存储浏览器指纹，在项目中用于校验用户身份和埋点
                        resolve({ deviceFingers: fingerParamsObj, browserId: browserId });
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    function sha256WithLengthControl(input, outputLength) {
        if (outputLength === void 0) { outputLength = 32; }
        // 进行 SHA-256 加密
        var hash = crypto_js_1.default.SHA256(input);
        // 获取加密结果的子串，控制位数为 outputLength
        var hashSubstring = hash.toString(crypto_js_1.default.enc.Hex).substring(0, outputLength);
