...
import { createOrg, org, deleteOrg, deleteNode, getChildrenNodes, addMember, getMembersById, addNode, updateNode, moveNode, removeMembers, isRootNode, rootNode, nodeById, setMainDepartment, listNodeByIdAuthorizedResources, listNodeByCodeAuthorizedResources, moveMembers, searchNodes, orgs, nodeByCode } from '../graphqlapi';
/**
...
var OrgManagementClient = /** @class */ (function () {
     ...
     * @memberof OrgManagementClient
     */
    OrgManagementClient.prototype.getNodeByCode = function (orgId, code) {
        return __awaiter(this, void 0, void 0, function () {
            var node;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, nodeByCode(this.graphqlClient, this.tokenProvider, {
                            orgId: orgId,
                            code: code
                        })];
                    case 1:
                        node = (_a.sent()).nodeByCode;
                        return [2 /*return*/, node];
                }
            });
        });
