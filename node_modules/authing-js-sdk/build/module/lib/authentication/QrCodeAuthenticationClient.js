        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                ...
                if (!node) {
                    ...
                    node.id = domId;
                    createCssClassStyleSheet('__authing-qrcode-node-mount', "z-index: 65535;position: fixed;background: #fff;width: ".concat(containerSize.width, "px;height: ").concat(containerSize.height, "px;left: 50%;margin-left: -").concat(containerSize.width /
                ...
                genShadowMiddleStatus = function (text) {
                    ...
                    createCssClassStyleSheet('__authing-shadow-inner-text-style-position', "font-weight: 400;font-size: 14px;line-height: 20px;color: #282D3C;;align-items: center; /*\u5782\u76F4\u5C45\u4E2D*/justify-content: center; /*\u6C34\u5E73\u5C45\u4E2D*/");
                ...
                genShadow = function (text, aOnClick, shadowAId) {
                    ...
                    shadow.id = shadowId;
                    createCssClassStyleSheet('__authing-shadow-style', "text-align:center;width: ".concat(size.width, "px;height: ").concat(size.height, "px;position: absolute;left: 50%;top: 0px;margin-left: -").concat(size.width /
                ...
                displayScannedUser = function (_) {
                    ...
                    createCssClassStyleSheet('__authing-shadow-style-position', "text-align:center;width:".concat(size.width, "px;height: ").concat(size.height, "px;background:rgba(255,255,255,.97);position: absolute;left: 50%;top: 0px;margin-left: -").concat(size.width /
