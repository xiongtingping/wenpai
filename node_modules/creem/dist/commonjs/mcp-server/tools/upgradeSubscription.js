...
exports.tool$upgradeSubscription = void 0;
...
exports.tool$upgradeSubscription = {
    name: "upgrade-subscription",
    description: `Upgrade a subscription to a different product`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, upgradeSubscription_js_1.upgradeSubscription)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
